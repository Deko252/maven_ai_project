...
//    @ResponseBody
    public String encodingTrans(String msg, String lang){//text :입력한 문장, lang: 나라별 기호
        String jsonData="";
        String clientId = "b4oftbh6sk";//애플리케이션 클라이언트 아이디값";
        String clientSecret = "wh0hQ7MAhxmzeOppvj6Wbk0g9705IdVIxEcCRN86";//애플리케이션 클라이언트 시크릿값";
        try {
...
//            System.out.println("before return : " + jsonData);
        } catch (Exception e) {
